            ...
            questions: [
                {
                    ...
                    answer: "Backend or full-stack roles (backend-leaning). I enjoy building APIs, designing clean architectures, writing tests, and shipping reliable deployments.",
                },
                {
                    question: "What do you build most often?",
                    answer: "Production-oriented systems with TypeScript: REST APIs, authentication, validation, database design with Prisma/PostgreSQL, and integrations (including AI services).",
                },
                {
                    question: "How do I work day-to-day?",
                    answer: "I focus on clarity and maintainability: clean layering, small reusable modules, predictable error handling, and test coverage for critical flows. I like shipping in small iterations.",
                },
                {
                    question:
                        "What makes my projects different from typical portfolio apps?",
                    answer: "They’re built with real-world concerns in mind: security basics (JWT, hashing, rate limiting), structured validation, logging, automated testing, and deployments — not just UI demos.",
                },
                {
                    question: "Where am I based?",
                    answer: "I'm Venezuelan and currently based in Montevideo, Uruguay (since 2020). Open to remote opportunities.",
                },
                {
                    question: "Do I freelance?",
                    answer: "Occasionally — but my main focus right now is joining a team full-time where I can grow fast and contribute consistently.",
                },
            ],
        },
