        ...
        >
            ...
            >
                <div className="relative w-full h-full flex items-center justify-center">
                    <i
                        className={`fas fa-sun text-[10px] absolute transition-all duration-300 ${theme === 'dark' ? 'opacity-100 scale-100 rotate-0 text-primary' : 'opacity-0 scale-50 rotate-90 text-text-base'}`}
                    ></i>
                    <i
                        className={`fas fa-moon text-[10px] absolute transition-all duration-300 ${theme === 'light' ? 'opacity-100 scale-100 rotate-0 text-primary' : 'opacity-0 scale-50 -rotate-90 text-primary'}`}
                    ></i>
                </div>
            </div>
        </button>
