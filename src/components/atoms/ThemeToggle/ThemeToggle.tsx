        ...
        >
            ...
            >
                <div className="relative w-full h-full flex items-center justify-center">
                    {/* Sun Icon - inline SVG */}
                    <span className={`absolute transition-all duration-300 ${theme === 'dark' ? 'opacity-100 scale-100 rotate-0 text-primary' : 'opacity-0 scale-50 rotate-90 text-text-base'}`}>
                    ...
                    <span className={`absolute transition-all duration-300 ${theme === 'light' ? 'opacity-100 scale-100 rotate-0 text-primary' : 'opacity-0 scale-50 -rotate-90 text-primary'}`}>
                        <svg className="w-[10px] h-[10px]" fill="currentColor" viewBox="0 0 20 20">
